...
<?php else : ?>
	...
	<div id="no-topic-<?php bbp_topic_id(); ?>" class="bbp-no-topic">
		<div class="bbp-template-notice">
			<p><?php is_user_logged_in() ? _e( 'You cannot create new topics.', 'bbpress' ) : _e( 'You must be <a href="http://davehakkens.nl/community/login/">logged in</a> to create new topics.', 'bbpress' ); ?></p>
		</div>
	</div>
