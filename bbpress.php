...
get_template_part('navbar'); ?>
  ...
  <div id="content" class="page-forum <?php echo str_replace(' ', '-', strtolower(bbp_get_forum_title())); ?>">
    ...
    <div class="post<?php echo get_field('headerimage') == '' ? ' no-headerimage' : '' ; ?>">

      <?php if (get_field('headerimage') != ''): ?>
        <div style="background-image: url('<?php echo get_field('headerimage'); ?>');" class="thumbnail">
      ...
      <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
        ...
        <?php if (get_field('headerimage') == ''): ?>
          <div class="center"><?php the_post_thumbnail(array(120,120)); ?></div>
